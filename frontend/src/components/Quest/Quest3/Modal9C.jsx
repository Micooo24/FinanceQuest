    ...
    >
      <Fade in={showModal}>
        ...
        >
          ...
          "Great! You’ll start with basic tasks—assembling orders, cleaning, and working the cash register. Let’s see how you do today."
          </Typography>
