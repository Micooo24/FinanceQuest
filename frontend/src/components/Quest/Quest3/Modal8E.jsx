    ...
    >
      <Fade in={showModal}>
        ...
        >
          ...
          "Liza learns how to take orders, make simple drinks, and serve customers. By the end of the shift, she’s exhausted but excited."          
          </Typography>
