...
const Modal2InnerThoughts = ({ onContinue }) => {
    ...
    >
      <Fade in={showModal}>
        ...
        >
          ...
          <Typography variant="body1" sx={{ color: '#000', mb: 2, fontFamily: "'Fraunces', serif", fontSize: "20px", fontStyle: 'italic' }}>
            "I finally made it here. But now, I have to make sure I survive the month with only ₱5,000 in my pocket."
          </Typography>
...
export default Modal2InnerThoughts;