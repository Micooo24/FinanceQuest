      ...
      <Fade in={showModal}>
        ...
        >
          ...
          <Typography variant="body1" sx={{ color: '#000', mb: 2, fontFamily: "'Fraunces', serif", fontSize: "20px" }}>
            "You finally arrive at a narrow alley leading to a boarding house. Students chat on the small balcony, while the smell of instant noodles lingers. A middle-aged man approaches, arms crossed."
          </Typography>
...
export default Modal3BoardingHouse;