...
const BudgetingBlog = () => {
  ...
  return (
    <Box sx={{ minHeight: "100vh", backgroundColor: "#fff", color: "#351742" }}>
      <Navbar />
        ...
        <Box sx={{ display: "flex", gap: 4, flexDirection: { xs: "column", md: "row" } }}>
          ...
          <Box sx={{ flex: 2 }}>
            ...
            <Typography sx={{ fontSize: "1.1rem", fontFamily: "'Lilita One'", mt: 2, textAlign: "center", color: "#000000" }}>
              Budgeting is one of the most important skills when it comes to managing money...
            </Typography>
            {[
          ...
          <Box sx={{ display: "flex", justifyContent: "center", gap: 4, mt: 3, flexWrap: "wrap" }}>
            <Card sx={{ width: "300px" }}>
              <CardContent>
                ...
                <Button component={Link} to="/savingBlog" sx={{ mt: 1, fontWeight: "bold", color: "#351742", fontFamily: "'Lilita One'" }}>
                  Read More
                </Button>
              </CardContent>
            </Card>
...
const getTipContent = (index) => {
  const tips = [
    "Before creating a budget, you need to know how much money is coming in and going out...",
    "A simple budgeting method is the 50/30/20 rule: 50% for needs, 30% for wants, and 20% for savings...",
    "After tracking your expenses, set a realistic budget based on your income...",
    "Before making a purchase, ask yourself if it is a need or a want...",
    "Dining out frequently can drain your budget fast...",
    "Take advantage of student discounts and promotions...",
    "Sales and online shopping temptations can lead to overspending...",
    "Unexpected expenses can arise at any time...",
    "If your budget is tight, explore side hustles or freelancing...",
    "Budgeting does not mean depriving yourself...",
  ];
  return tips[index];
};
