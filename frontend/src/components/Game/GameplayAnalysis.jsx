  ...
  // import { FaHome, FaTrophy, FaCoins, FaChartLine, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
  ...
  // const GameAnalysis = ({ userData }) => {
  //   const navigate = useNavigate();
  //   const [gameData, setGameData] = useState(null);
  //   const [activeSlide, setActiveSlide] = useState(0); // 0 = chart, 1 = analysis
    
  // // Update the chartData object in your component:

  // const chartData = {
  //     labels: ['Start', 'Q1', 'SQ1', 'Q2', 'SQ2', 'Current'],
  //     datasets: [
  //       {
  //         label: 'Money',
  //         data: [1000, 1500, 1800, 2000, 2300, 2300], 
  ...
  //           return context.dataset.label === 'Money' ? '#8a2be2' : '#ff69b4';
  //         },
  ...
  //   useEffect(() => {
  //     // Process the user data here when it becomes available
  //     if (userData) {
  ...
  //             <h3>Decisions</h3>
  //             <p>{gameData ? 
  //                 Object.keys(gameData).filter(key => key.includes('decision')).length 
  //                 : '4'}</p>
  //           </div>
  //         </div>
  //       </div>
  ...
  //               <h2>Your Financial Journey Analysis</h2>
  //               <p className="analysis-description">
  //                 Here's your personalized analysis of your financial decisions in Finance Quest! 
  //                 You've made some great choices that have helped you build your wealth.
  //               </p>
  ...
  //                         <br />
  //                         <span>Decision: {gameData?.q1_decision || 'Delayed payment'}</span>
  //                         <br />
  //                         <span className="reward">+{gameData?.q1_outcome?.points_earned || '5'} points earned</span>
  //                       </li>
  //                     </div>
  ...
  //                         <br />
  //                         <span>Status: {gameData?.sq1_done ? 'Completed!' : 'Not attempted'}</span>
  //                         <br />
  //                         <span className="reward">+{gameData?.sq1_outcome?.points_earned || '10'} points earned</span>
  //                       </li>
  //                     </div>
  ...
  //                         <br />
  //                         <span>Decision: {gameData?.q2_decision || 'Chose online banking'}</span>
  //                       </li>
  //                     </div>
  ...
  //                         <br />
  //                         <span>Decision: {gameData?.sq2_decision || 'Made deposit'}</span>
  //                       </li>
  //                     </div>
  //                   </div>
  //                 </div>
  ...
  //   const userId = localStorage.getItem('userId') || 'defaultUserId'; // Replace with actual user ID logic
  ...
  //     // Trigger the POST request to analyze stats
  ...
  //       try {
  //         const response = await axios.get(`http://localhost:8000/stats_ai/get-stats-analysis/${userId}`);
  ...
  //     analyzeStats().then(fetchAnalysis);
  //   }, [userData, userId]);
  ...
  //               <h2>Your Financial Journey Analysis</h2>
  //               <p className="analysis-description">
  //                 {analysis || "Here's your personalized analysis of your financial decisions in Finance Quest! You've made some great choices that have helped you build your wealth."}
  //               </p>
...
//           playerData?.sq3_outcome?.money_spent || 0,
//         ],
//         borderColor: '#8a2be2', // Purple
//         backgroundColor: 'rgba(138, 43, 226, 0.2)',
//         borderWidth: 3,
...
//         // This adds a subtle glow to each data point
//         hoverBackgroundColor: function(context) {
//           return context.dataset.label === 'Money Spent' ? '#8a2be2' : '#ff69b4';
//         },
//         hoverBorderColor: '#fff',
//         hoverBorderWidth: 3,
//         hoverRadius: 8,
...
//             <h3>Decisions</h3>
//             <p>{playerData ? 
//                 Object.keys(playerData).filter(key => key.includes('decision')).length 
//                 : '0'}</p>
//           </div>
//         </div>
//       </div>
...
import { Line } from 'react-chartjs-2';
import { Chart, registerables } from 'chart.js';
import { FaHome, FaTrophy, FaCoins, FaChartLine, FaChevronLeft, FaChevronRight, FaLightbulb, FaMedal } from 'react-icons/fa';
import { useNavigate } from 'react-router-dom';
import axios from 'axios';
import './GameplayAnalysis.css';
    ...
    datasets: [
      ...
      },
      {
        ...
        data: [
          ...
          playerData?.sq3_outcome?.money_earned || 0,
        ],
        borderColor: '#00cac9', // Green
        backgroundColor: '0 0 10px rgba(0, 202, 201, 0.6)',
        borderWidth: 3,
        tension: 0.4,
        ...
        fill: {
          target: 'origin',
          above: '0 0 10px rgba(0, 202, 201, 0.6);',
        }
      },
    ],
  };
          ...
          <div className="decision-summary">
            <div className="quest-slider-container">
              <div className="quest-slider">
                ...
                <div className="quest-slide">
                  <li>
                    <strong>Side Quest 3:</strong> Budget Planning
                    <br />
                    <span>Decision: {playerData?.sq3_decision || 'None'}</span>
                    <br />
                    <span className="reward">+{playerData?.sq3_outcome?.points_earned || '0'} points earned</span>
                    <br />
                    <span className="money_earned">+₱{playerData?.sq3_outcome?.money_earned || '0'}</span>
                    <br />
                    <span className="money_spent">-₱{playerData?.sq3_outcome?.money_spent || '0'}</span>
                  </li>
                </div>
              </div>
            </div>
